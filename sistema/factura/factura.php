...
<div id="page_pdf">
	<table id="factura_head">
		<tr>
			<td class="logo_factura">
				<img style="width:85%;" src="<?php echo $imagenBase64; ?>">
			</td>
			...
			<td class="info_factura">
				<div class="round">
					...
					<p>No. Factura: <strong><?php echo $factura['nro_factura']; ?></strong></p>
			...
			<td class="info_cliente">
				<div class="round">
					...
					<table class="datos_cliente">
						<tr>
							<td><label>Cédula:</label><p><?php echo $factura['cedula']; ?></p></td>
	...
	<table id="factura_detalle">
			...
			<tfoot id="detalle_totales">
				<tr>
					<td colspan="3" class="textright"><span>SUBTOTAL Bs.</span></td>
					<td class="textright"><span><?php echo number_format($tl_sniva,2,',',' .'); ?></span></td>
				</tr>
				<tr>
