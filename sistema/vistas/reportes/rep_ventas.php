      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
            <section class="wrapper">
                ...
                <h3><i class="fa fa-angle-right"></i> Reporte de items más vendidos</h3>
            ...
            <section>
                <div style="padding:5%;">
                    <!-- Botón para ver PDF -->
                    <button class="btn btn-primary" id="verPDF" style="outline:none;">
                        <i class="fa fa-file-pdf-o" aria-hidden="true"></i> Generar reporte en PDF
                    </button>
                    <div
                        class="table-responsive" style="background:white;"
                        ...
                        >
                            ...
                            >
                                <tr>
                                    ...
                                    <th style="font-weight:900;" scope="col">Total vendido</th>
                                </tr>
                            </thead>

                            <?php 
                            $sql2 = mysqli_query($conn, "SELECT p.id_producto, p.nombre, p.stock, SUM(df.cantidad) AS total_vendido
                                                        FROM detallefactura df
                                                        INNER JOIN producto p
                                                        ON df.codproducto = p.id_producto
                                                        WHERE df.codproducto != 115005451
                            ...
                            <tbody>
                                <tr class="">
                                    ...
                                    <td><?php echo $data['total_vendido']; ?></td>
                                </tr>
                            </tbody>
