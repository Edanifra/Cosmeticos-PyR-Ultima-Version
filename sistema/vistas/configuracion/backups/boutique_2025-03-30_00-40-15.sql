...
INSERT INTO `configuracion` VALUES (1,'J-00015646483','PyR Cosmetics C.A','0424-598-0204','pyrcosmetics@gmail.com','Zona Comercial La Mora, calle 37, Venezuela, Edo. Aragua',16,'#4b793f','#9ccc8d','#73a266');
...
INSERT INTO `delivery` VALUES (9,'2024-12-09','0',13.5,4,1,15);
...
INSERT INTO `detalle_carrito` VALUES (167,'a87ff679a2f3e71d9181a67b7542122c',4,1,12.00),(169,'a87ff679a2f3e71d9181a67b7542122c',2,3,13.50);
...
INSERT INTO `detalle_delivery` VALUES (6,9,2,4,1,13.50,1);
...
INSERT INTO `direccion` VALUES (7,'Avenida 18, Turmero, Calle 17, Casa #32.',5),(8,'Avenida Aragua, Calle 22, edificio 3, vereda 12.',1),(9,'La Colonia, Colonial 27, vereda 1.',3),(10,'Avenida 22, calle 13, caracaya.',2),(11,'Avenida Rivas, hospital, Calle 42, vereda 15.',7),(12,'La mexicana, guanajuato 13, simp 44.',8),(13,'Avenida Aragua, Calle caricuao, vereda 27.',6),(15,'Avenida Aragua, Landaeta Ferrer, Vereda #32.',4);
...
INSERT INTO `empleado` VALUES (1,'admin','edwin','fragiel',1,'ewin@gmail.com','admin','','Nombre de su primera mascota','chiki',2,1),(2,'juan','si','no',2,'awa@gmail.com','wawa','','Pasatiempo favorito','bateria',0,1),(3,'elharry_26','Luis','Alfonzo',3,'harry@gmail.com','jj','030303','Pelicula favorita','dark souls',0,1),(4,'edelberto','Edelbert','Borrero',3,'edel@gmail.com','1234','04040404','Pasatiempo favorito','jugar',0,1),(5,'joseju','jose','juanjo',2,'jj','','50505','','no\r\n',0,1);
...
INSERT INTO `tutoriales` VALUES (1,'registrar productos.mp4','Cómo registrar un producto','Tutorial de cómo hacer un registro en la tabla producto'),(2,'facturacion.mp4','Procesar venta','Tutorial de cómo procesar una venta'),(3,'registrar categoria.mp4','Registrar categoría','Tutorial de cómo registrar una categoría'),(4,'registrar productos.mp4','Aprobar pedido','Tutorial de cómo aprobar un pedido');
...
-- Dump completed on 2025-03-29 19:40:15
