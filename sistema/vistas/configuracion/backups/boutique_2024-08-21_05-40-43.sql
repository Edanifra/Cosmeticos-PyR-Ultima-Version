...
) ENGINE=InnoDB AUTO_INCREMENT=115005453 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `producto` VALUES (1,'Colonia NightKing Special 120ml','Colonia para noche de caballero de 120ml',20,15,2,10,1,'NightKing',1,'img/1.jpg'),(2,'Crema Nivea Hidratacion','Crema de hidratación profunda 150ml',32,24,1,5,2,'Nivea',1,'img/2.jpg'),(4,'Colonia Swiss Army','Colonia de caballero Noche 100ml',15,24,1,6,1,'Swiss Army Inc',1,'img/3.jpg'),(6,'Tinte Revlon 1.0 Negro','Tinte para cabello color negro puro',15,36,1,5,3,'Revlon',1,'img/4.jpg'),(7,'Placha para cabello Revlon','Plancha profesional para cabello marca Revlon',55,6,1,3,4,'Revlon',1,''),(8,'Esmalte Valmy #51 Tiza','Esmalte para uñas marca Valmy color #51 blanco tiz',8,16,1,15,5,'Valmy',1,''),(115005451,'Domicilio','Servicio de entrega a domicilio',2,9999999,1,1,6,'',1,'');
...
-- Dump completed on 2024-08-20 23:40:43
