<?php
    ...
    if (empty($_SESSION['admin']['activo'])) {
        ...
        $sql = @mysqli_query($conn, "SELECT * FROM empleado WHERE estado = 1 ORDER BY id_empleado DESC
...
<php lang="en">
  ...
  <section id="container" >
        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <div class="content-panel">
                    <table class="table table-striped table-advance table-hover" id="listaUsuarios" style="margin-top: 1em;">
	              	    <h4 style="display:contents;"><i class="fa fa-angle-right" style="margin:10px;"></i> Lista de usuarios</h4>
                        <a href="../../../signin.php" style="margin-left:1em;" class="btn btn-primary"><i class="fa fa-plus"></i> Agregar usuario</a>
                        <a style="margin-left:10px;" href="#" class="btn btn_excel" id="modal_excel_usu"><i class="fa fa-table"></i> Cargar archivo CSV</a>
                        ...
                        <tbody>
                            ...
                            <tr id="row_<?php echo $data['id_empleado']; ?>">
                                ...
                                <?php if ($_SESSION['admin']['rol'] == 1) {?>
                                <td>
                                    <a href="#" id="btn_eliminar_usuario" id_usuario="<?php echo $data['id_empleado']; ?>" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
                                </td>
                                <?php } ?>
                            </tr>
    ...
    <script>
        ...
        if (!$.fn.DataTable.isDataTable('#listaUsuarios')) {
            $('#listaUsuarios').DataTable({
                "language": {
