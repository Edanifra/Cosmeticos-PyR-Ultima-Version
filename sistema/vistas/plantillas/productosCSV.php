...
<php lang="en">
  <head>
    ...
    <title>Cargar productos por CSV</title>
                ...
                <div class="row mt">
                    <div class="contentPanel centrarContentPanel">
                        ...
                        <div class="contentPanel centrarContentPanel" style="background:white; width:50%; border-radius:5px;">
                            ...
                            <img style="border-radius:5px; width:90%;" src="../../imagenes/plantillas/productos/prt-1.png" alt="">
                    ...
                    <div class="contentPanel centrarContentPanel">
                        <div class="contentPanel centrarContentPanel" style="background:white; width:50%; border-radius:5px;">
                            ...
                            <span style="width:60%; margin:1em;">
                                ...
                                primero el código de barras, luego el nombre, descripción, precio, el stock mínimo, el stock 
                                máximo y la marca del producto.  Una vez concretado este paso, hacemos click en 
                    ...
                    <div class="contentPanel centrarContentPanel">
                        <div class="contentPanel centrarContentPanel" style="background:white; width:50%; border-radius:5px;">
                            ...
                            <span style="width:60%; margin:1em;">
                                Ahora nos dirigimos a <a href="../productos/listaProductos.php" style="text-decoration:underline;">lista de productos</a> 
                    ...
                    <div class="contentPanel centrarContentPanel">
                        <div class="contentPanel centrarContentPanel" style="background:white; width:50%; border-radius:5px;">
                            ...
                            <span style="width:60%; margin:1em;">
                                ...
                                el documento CSV modificado donde hemos cargado los productos. Una vez hecho esto, 
                    ...
                    <div class="contentPanel centrarContentPanel">
                        <div class="contentPanel centrarContentPanel" style="background:white; width:50%; border-radius:5px;">
                            ...
                            <span style="width:60%; margin:1em;">
                                En la lista de productos verificamos que los productos que hemos cargado en el archivo CSV se 
                                hayan añadido al sistema, para finalizar, solamente faltaría añadir su respectiva foto a cada producto 
                                y modificar la categoría a la que pertenecen con el fin de categorizar con orden cada producto dentro 
                                del sistema.
                            </span>
                        </div>
                    </div>
                    <div class="contentPanel centrarContentPanel" style="margin-bottom: 5em;">
                        <a href="archivos/productos.csv" class="btn btn_excel"><i class="fa fa-download" aria-hidden="true"></i> Descargar archivo CSV</a>
                    </div>
                </div>
		    </section><!-- /wrapper -->
