                    ...
                    <div class="col-md-12">
                        <div class="content_panel centrarContentPanel">
                            <div style="padding: 1em;background: white;border-radius: 5px; width: 55%;">
                                <form action="../../controladores/productos/cargar_excel.php" method="POST" enctype="multipart/form-data">
                                    <input type="file" style="display:none;" name="cargar_excel" id="cargar_excel" required>
                                    <div class="modalButtons">
                                        <label for="cargar_excel" class="btn btn_excel"><i class="fa fa-table"></i> Cargar archivo</label>
                        ...
                        <div class="content-panel">
                            <table class="table table-info table-bordered table-hover">
                                ...
                                <thead>
                                    <tr>
                                        <th class="table_headers"><i class="fa fa-bullhorn"></i> SKU interno</th>
                                        <th class="table_headers"><i class="fa fa-bullhorn"></i> Código de barras</th>
                                        <th class="table_headers" style="width: 200px;"><i class="fa fa-bullhorn"></i> Nombre</th>
                                        <th class="table_headers" class="hidden-phone" style="width: 250px;"><i class="fa fa-question-circle"></i> Descripción</th>
                                        <th class="table_headers" class="hidden-phone"> Stock</th>
                                        <th class="table_headers" class="hidden-phone"> Stock Min</th>
                                        <th class="table_headers" class="hidden-phone"> Stock Max</th>
                                        <th class="table_headers"><i class="fa fa-bookmark"></i> Precio</th>
                                        <th class="table_headers"><i class=" fa fa-edit"></i> Categoría</th>
                                        <th class="table_headers"><i class=" fa fa-edit"></i> Marca</th>
                                    </tr>
                                </thead>
                                <tbody>
